...
/**
 * ContentApi provide methods to communicate
...
export class ContentApi {
     ...
     * In case el gamal keys were never been changed, only one key should be provided.
     * If keys were changed, provided keys may contains older keys,
     ...
     *
     * @param {SubmitObject} content    Content information.
     * @param {string} privateKey       Author's private key
     * @return {Promise<void>}
     */
     ...
     * @param {string} elGammalPub  ElGammal public key which will be used to identify user's bought content
     ...
     *
     * @param {string} accountId        Account id of user to be purchased content listed for. example: '1.2.345'
     * @param {string} order            Result ordering option. Available options in SearchParamsOrder. example: '1.2.345'
     * @param {string} startObjectId    Id of object to start list from, e.g. for paging purpose. example: '1.2.345'
     * @param {string} term             Term to be searched in purchased content. example: '1.2.345'
